export default function Experincia() {
    return(
        <section
        className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24"
        aria-label="Experiencia de trabalho"
      >
        <div
          className="sticky top-0 z-20 -mx-6 mb-4 w-screen bg-slate-900/10
        px-6 py-4 backdrop-blur md:-mx-12 md:px-12 lg:sr-only lg:relative lg:top-auto
                ...
                <div className="z-10 sm:col-span-6">
                  <h3 className="font-medium leading-snug text-slate-200">
                    <div>
                      ...
                      >
                        <span
                          className="absolute -inset-x-4 -inset-y-2.5 hidden
                    ...
                    <div>
                      <div className="text-slate-500" arial-hidden="true">
                        Enginner
                      </div>
                    </div>
                  </h3>
